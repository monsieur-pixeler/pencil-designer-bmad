...
# dependencies = []
# ///
"""BMad module registration helper — merge module help entries into shared _bmad/module-help.csv.

Invoked by: assets/module-setup.md (BMad module registration workflow)
Not a capability script — do not call from design capabilities.
